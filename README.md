> [!IMPORTANT]
> Semaphore is no longer supported, the [semaphore.social](https://semaphore.social) domain is now forwarded to [semaphore-social.vercel.app](https://semaphore-social.vercel.app) and will be suspended to avoid paying for domain costs.
> The vercel instance will stay up as long as it remains free.
